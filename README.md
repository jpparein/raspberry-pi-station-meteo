...
![Démonstration animée de l'interface](docs/images/DemoV2.gif)
...
|---|---|---|
| DHT22 / AM2302 module 3 broches | [Amazon](https://www.amazon.fr/s?k=DHT22+AM2302+module+3+broches) | [Gotronic](https://www.gotronic.fr) |
| BMP280 module I2C | [Amazon](https://www.amazon.fr/s?k=BMP280+module+I2C) | [Gotronic](https://www.gotronic.fr) |
| Raspberry Pi 2B/3B/4/Zero 2 W | [Amazon](https://www.amazon.fr/s?k=Raspberry+Pi) | [Kubii](https://www.kubii.fr), [Gotronic](https://www.gotronic.fr) |
...
| Fils Dupont + gaine thermorétractable | [Amazon](https://www.amazon.fr/s?k=fils+Dupont+gaine+thermoretractable) | [Gotronic](https://www.gotronic.fr) |
| Clé Wi-Fi USB (optionnel) | [Amazon](https://www.amazon.fr/s?k=clé+wifi+usb) | — |

> Les liens Amazon sont des recherches prêtes à l'emploi. Les liens Gotronic/Kubii pointent vers la page d'accueil (catégories accessibles depuis le menu). Choisissez un vendeur bien noté. Pour le Raspberry Pi, privilégiez les revendeurs officiels (Kubii, Gotronic) pour éviter les contrefaçons.
